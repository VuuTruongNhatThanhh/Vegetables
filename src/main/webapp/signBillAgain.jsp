...
<form method="post" action="VerifyOrderStatus?id=<%= billId %>">

    <div style="max-width: 1200px">
        <p style="padding-left: 30px"><strong>Nhập private key của bạn để thực hiện ký hóa đơn</strong></p>
        <p style="padding-left: 30px"><strong>Mã hóa đơn: </strong> <%= billId %></p>
        <%--    <p  style="word-wrap: break-word;padding-left: 30px"><%= request.getAttribute("privateKey") %></p>--%>
        <textarea style="word-wrap: break-word;margin-left: 30px"  name="key" rows="4" cols="50"></textarea><br>
        <button  style="word-wrap: break-word;margin-left: 158px; margin-top: 10px; width: 100px ;background: #82cd47; color: white; border-color: #82cd47" type="submit" name="submit" >Ký hóa đơn</button>
        <%
            Object notiAttribute = request.getAttribute("noti1");
