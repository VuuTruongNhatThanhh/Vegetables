...
public class GetFee {
    public static Double calculateShippingFee(String token, String from_district_id, String from_ward_id, String to_district_id, String to_ward_id) throws IOException, IOException, JSONException {
