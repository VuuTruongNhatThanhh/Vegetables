...
public class RegisterTransport {
    public static Transport registerTransport(String token, Bills order, String from_district_id, String from_ward_id, String to_district_id, String to_ward_id) throws IOException, JSONException {
        String height = "20";
        String length = "20";
        String width = "20";
        String weight = "2000";
    ...
    public static void main(String[] args) throws IOException, JSONException, ParseException {
        String token = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..b5YllaXBiDNTk_PdszzN8nCBB2le-QzLwPKDKfpu4Qg";
        try {
            ...
            TransportDao.getInstance().addTransport(transport,"11");
