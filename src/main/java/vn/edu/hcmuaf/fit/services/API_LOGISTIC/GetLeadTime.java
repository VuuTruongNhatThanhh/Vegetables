...
public class GetLeadTime {
    public static String getLeadTime(String token, String from_district_id, String from_ward_id, String to_district_id, String to_ward_id) throws IOException, JSONException {
