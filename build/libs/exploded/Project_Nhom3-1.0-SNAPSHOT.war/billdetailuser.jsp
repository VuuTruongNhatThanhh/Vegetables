...
<div class="row">
    ...
    <div class="row col-8">
        <div style="height: 20%;" class="tab row col-12">
            <button style="height: 10%" class="tablinks col-3" onclick="openCity(event, 'tab1')" id="defaultOpen">Sản
                phẩm trong đơn hàng
            </button>
        ...
        <div id="tab1" class="tabcontent">
            <div class="card">
                <div class="card-body">
                    ...
                    <p style="padding-left: 8px;">Tổng tiền: ${tp} VND, vận chuyển: ${fee} VND</p>
<%--                    <p style="padding-left: 8px;">Mã vận chuyển: ${idTrans}, thời gian giao dự kiến: ${leadtime}</p>--%>
                </div>
            </div>
        </div>
